const PATHS = {
  ...
  pencil: <path d="M4 20h4.5L19 9.5 14.5 5 4 15.5V20ZM13.5 6l4.5 4.5" />,
  ...
  upload: <path d="M12 15V4M7 9l5-5 5 5M5 15v3.5A1.5 1.5 0 0 0 6.5 20h11a1.5 1.5 0 0 0 1.5-1.5V15" />,
